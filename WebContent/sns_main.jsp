...
<script type='text/javascript'>
	...
	function heart_Popup(a) {
		window.open("goods.jsp?ww=" + a, "heart_Popup",
...
<body>
	<div class="Site-header">
		<h1 class="Site-logo">
			<a href="home.jsp" class="Site-logo_link"> <span
	...
	<div id="wrapper1">
		<section id="main">
			<section id="content">
					...
					<c:when test="${uid != null}">
						...
						<div class="New_post">
							...
							<form class="m_form" method="post"
								action="upload.jsp?action=newmsg" enctype="multipart/form-data">
						...
						<div>
							...
							<div class="Good">
									...
									<c:when test="${uid != null}">
										<div class="Good_div">
											<sns:smenu mid="${m.mid}" auid="${m.uid}"
												curmsg="${mcnt.index}" />
											<a href="sns_comment.jsp?ww=${m.mid}" id="SNS_comment"><i
								...
								<div class="Write_div">
									...
									<form action="/Weekend/gta?action=newreply&cnt=${cnt}"
										method="post">
				...
				<div align="center">
					<a
						href="/Weekend/gta?action=getall&cnt=${cnt+5}&suid=${suid}&curmsg=${cnt}">더보기&gt;&gt;</a>
				</div>
		...
		<c:otherwise>
			...
			<script type="text/javascript">
				...
				var webSocket = new WebSocket(
						"wss://282569c1.ngrok.io/Weekend/broadsocket");
	...
	<div class="flBtn flBtn-position-br flBtn-size-medium">
		...
		<ul class="flBtn-second">
			<li><a id="kakao-link-btn" href="javascript:sendLink()"
				tooltip="kakao"> <img src="css/images/kakao-talk.svg"
			...
			<li><a href="javascript:naver();" tooltip="naver"><img
					src="css/images/naver_icon.svg" style="width: 25px; height: 40px;"></a></li>
			<li><a href="javascript:void(0);" onclick="share_band('주말플러스', 'https://282569c1.ngrok.io/Weekend/main.jsp');return false;" tooltip="Band"><img src="css/images/naverband_icon.JPG"
