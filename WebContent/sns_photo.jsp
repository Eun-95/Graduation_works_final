...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" href="css/sns_photo.css" />
...
<body>
			<c:choose>
				...
				<c:otherwise>
					...
					ArrayList<Message> L=m.showImg();
					for(int i=0; i<L.size(); i++){
						out.println("<div class='slide'><img src='/Weekend/upload/"+L.get(i).getImg()+"'>"+"<p>"+L.get(i).getMsg()+"</p>"+"</div>");
					}
