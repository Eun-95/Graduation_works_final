...
<script type='text/javascript'>
	...
	function shareFB()
	{
		...
		window
				.open('https://www.facebook.com/sharer/sharer.php?u=https://282569c1.ngrok.io/Weekend/main.jsp');
...
<div class="flBtn flBtn-position-br flBtn-size-medium">
	...
	<c:choose>
					<c:when test="${uid != null}">
					<li><a href="boardList.bo" tooltip="공지사항"><i class="far fa-edit"></i></a></li>
	...
	<li><a id="kakao-link-btn" href="javascript:sendLink()" tooltip="kakao"> <img
		...
		src="css/images/naverband_icon.JPG" style="width: 25px; height: 25px; margin-top: 7px;"></a></li>
	</ul>
</div>
